...
- **npm install**
_Run the application using the following command:
+ **ionic serve** 
_Access the application through your preferred web browser using the specified URL or run it on a mobile device using the Ionic DevApp.
